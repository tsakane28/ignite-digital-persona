            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <motion.div 
                  ...
                  className="absolute left-0 md:left-1/2 w-7 h-7 rounded-full border-4 border-primary bg-background transform md:-translate-x-3 -translate-y-1"
                />
                
                {/* Content */}
                <div className="w-full md:w-1/2 pl-10 md:pl-0 md:pr-12 pb-8 md:pb-0">
                  <div className={cn(
                    'glass-card p-6',
